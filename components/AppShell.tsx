...
import {
  ...
  IconChevronDown, IconChevronRight, IconFileText,
...
const NAV_GROUPS: { label: string; links: NavLink[] }[] = [
  {
    ...
    links: [
      ...
      { href: '/resumos', label: 'Resumos', icon: <IconFileText size={18} />, roles: ['aluno', 'professor', 'admin'] },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/disciplinas', label: 'Disciplinas', icon: <IconBooks size={18} />, roles: ['admin'] },
...
const PAGE_LABELS: Record<string, string> = {
  ...
  '/resumos': 'Resumos', '/notas': 'Notas', '/comunicados': 'Comunicados', '/horario': 'Horário',
  '/turmas': 'Turmas', '/disciplinas': 'Disciplinas', '/usuarios': 'Usuários', '/perfil': 'Meu Perfil',
};
        ...
        <header id="topbar">
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div className="tb-breadcrumb">
              <span className="tb-crumb" style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                <IconSchool size={16} /> <span className="hide-xs">EducaTurdi</span>
              </span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            >
              ...
              <span className="hide-xs" style={{ fontSize: 13, fontWeight: 500, color: 'var(--s600)', maxWidth: 130, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                {profile.nome}
              </span>
              <IconChevronDown size={14} style={{ color: 'var(--s400)' }} className="hide-xs" />
            </Link>
          </div>
        </header>
