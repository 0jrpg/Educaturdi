        ...
        <div className="table-wrap">
          {carregando ? (
            ...
            <table className="table">
              <thead><tr><th>Nome</th><th>E-mail</th><th>Tipo</th><th>Turma</th><th>Status</th><th>Cadastrado em</th><th></th></tr></thead>
              <tbody>
                {usuarios.map((u) => (
                  <tr key={u.id}>
                    <td>
                    ...
                    <td>
                      <StatusPresenca
                        lastSeen={presenca[u.id]?.last_seen ?? null}
                        pagina={presenca[u.id]?.pagina}
                        contextoTipo={presenca[u.id]?.contexto_tipo}
                        contextoTitulo={presenca[u.id]?.contexto_titulo}
                        compacto
                      />
                    </td>
