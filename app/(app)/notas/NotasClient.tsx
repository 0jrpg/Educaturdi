...
export default function NotasClient({
  modo, turmaAtual, notasPorAluno, alunosPorTurma, notasDoAluno, disciplinas, turmas, professorId,
}: {
  modo: 'aluno' | 'gestao';
  turmaAtual: string;
  ...
  return (
    <div>
      ...
      <LancarNotaModal open={modalLancar} onClose={() => setModalLancar(false)} disciplinas={disciplinas} turmas={turmas} professorId={professorId ?? ''} />
    </div>
  );
}
